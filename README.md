[![Austi-no](https://circleci.com/gh/Austi-no/Udacity-Project-4-.svg?style=svg)](https://circleci.com/gh/Austi-no/Udacity-Project-4-)
...
-   Define a `dockerpath` which is `<docker_hub_username>/<project_name>` e.g: `austino1228/udacity-p4`
-   Authenticate and tag image
-   Push your docker image to the `dockerpath`

> Note: replace <your_tag> with the tag name that you want to use. For example: api -> `docker build --tag=project4 .`
...
-   Add a status badge using this template: `[![<github_username>](https://circleci.com/gh/<github_username>/<repository>.svg?style=svg)](https://circleci.com/gh/<github_username>/<repository>)` replace `<github_username>` and `<repository>` with your data. e.g: `[![Austi-no](https://circleci.com/gh/Austi-no/Udacity-Project-4-.svg?style=svg)](https://circleci.com/gh/Austi-no/Udacity-Project-4-)` and paste on top of your readme file.
